import template from './strix-ergonode-import-history.html.twig';
import './strix-ergonode-import-history.scss';

const { Component } = Shopware;

Component.register('strix-ergonode-import-history', {
    template,
    ...
    data () {
        return {
            ...
            ListingColumns: [
                {
                    property: 'status',
                    label: this.$t('StrixErgonode.importHistory.grid.status'),
                    width: 'auto',
                },
                {
                    property: 'startDate',
                    label: this.$t('StrixErgonode.importHistory.grid.startedOn'),
                    width: 'auto',
                },
                {
                    property: 'endDate',
                    label: this.$t('StrixErgonode.importHistory.grid.endedOn'),
                    width: 'auto',
                },
            ],
            detailsColumns: [
                {
                    property: 'datetime',
                    label: this.$t('StrixErgonode.importHistory.details.createdAt'),
                },
                {
                    property: 'message',
                    label: this.$t('StrixErgonode.importHistory.details.message'),
                },
            ],
            detailsCache: {},
            detailsId: null,
