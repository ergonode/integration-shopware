...
class ProductMinMaxQuantityTransformer implements ProductDataTransformerInterface
{
    ...
    public function transform(ProductTransformationDTO $productData, Context $context): ProductTransformationDTO
    {
        ...
        $this->handleErasing($productData, 'minPurchase', 1);
        $this->handleErasing($productData, 'maxPurchase', null);
    ...
    private function handleErasing(ProductTransformationDTO $productData, string $key, ?int $default): void
    {
        $swData = $productData->getShopwareData();
